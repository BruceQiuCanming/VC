...
public:
	...
	void OnEnSetfocusEdit_2(UINT id);
	...
	afx_msg void OnEnChangeEditLowLevelSpanPlus5();
	double m_MainLevelAvrSpanMinus;
	double m_MainLevelAvrSpanPlus;
	double m_MainLevelCloseAvrSpanMinus;
	double m_MainLevelCLoseAvrSpanPlus;

	double m_HighLevelAvrSpanMinus;
	double m_HighLevelAvrSpanPlus;
	double m_HighLevelCloseAvrSpanMinus;
	double m_HighLevelCLoseAvrSpanPlus;

	double m_LowLevelAvrSpanMinus;
