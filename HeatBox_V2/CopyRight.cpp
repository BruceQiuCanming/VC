...
/*
		...
		if(G_iMaxLedNr == 192)
		{
			...
			cmd.crc = CComm::CRC16((unsigned char *)&cmd,sizeof(cmd)-2);//,(unsigned char*)cmd.crc);
		...
		else
		{
			...
			cmd.crc = CComm::CRC16((unsigned char *)&cmd,sizeof(cmd)-2);
