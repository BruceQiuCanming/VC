...
//CRC低位字节值表
const unsigned char crc16_lo[256]=
...
//'CRC高位字节值表
const unsigned char crc16_hi[256]=
{
...
void CRC16(unsigned char *source, int  n, unsigned char crc_init[2], unsigned char ReturnData[2])
{
  ...
  //7F 00 7F 
  //E0 B1
    volatile unsigned char CRC16Hi = crc_init[1];
    volatile unsigned char CRC16Lo = crc_init[0];
    int i;
    int iIndex;
...
//	ReturnData[1] = 0xEC;//                                'CRC高位
//    ReturnData[0] = 0xEC;//                                'CRC低位
