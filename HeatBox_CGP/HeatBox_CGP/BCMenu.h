...
public:
	...
	BOOL ModifyODMenuW(char/*wchar_t*/ *lpstrText,UINT nID=0,int nIconNormal=-1);
	BOOL ModifyODMenuW(char/*wchar_t*/ *lpstrText,UINT nID,CImageList *il,int xoffset);
	BOOL ModifyODMenuW(char/*wchar_t*/ *lpstrText,UINT nID,CBitmap *bmp);
	BOOL ModifyODMenuW(char/*wchar_t*/ *lpstrText,char/*wchar_t*/ *OptionText,int nIconNormal);
	...
	BOOL ModifyODMenuW(char/*wchar_t*/ *lpstrText,UINT nID,COLORREF fill,COLORREF border,int hatchstyle=-1,CSize *pSize=NULL);
