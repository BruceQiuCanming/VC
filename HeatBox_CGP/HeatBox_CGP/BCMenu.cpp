...
{
	USES_CONVERSION;
	return ModifyODMenuW((char*)/*A2W*/(lpstrText),nID,nIconNormal);//SK: see MFC Tech Note 059
}

BOOL BCMenu::ModifyODMenuW(char/*wchar_t*/ *lpstrText,UINT nID,int nIconNormal)
{
	int nLoc;
	BCMenuData *mdata;
