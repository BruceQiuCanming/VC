...
public:
	...
	{
		VARIANT result;
		InvokeHelper(0xcfe, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void ShowCard()
	{
	...
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xd4a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PictureURI);
	}
	void PastePictureInCell()
	{
		InvokeHelper(0xd4d, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void PlacePictureOverCells(VARIANT& AsReference)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xd4f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &AsReference);
	}
	void UpdatePictureInCellAlternativeText(LPCTSTR AlternativeText)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xd52, DISPATCH_METHOD, VT_EMPTY, NULL, parms, AlternativeText);
	}
	LPDISPATCH get_CellControl()
	{
		LPDISPATCH result;
		InvokeHelper(0xd53, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	void ResetContents()
	{
		InvokeHelper(0xd57, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void RemoveControls()
	{
		InvokeHelper(0xd56, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void TogglePythonMarshalMode(VARIANT& MarshalMode)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xd5b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &MarshalMode);
	}
